...
func WithLoggerFilePath(name string) LoggerEngineOption {
...
func (l *LoggerOption) start() {
	...
	// file output
	writeSyncer := zapWriteSyncer(l.fileName, l.maxSize, l.maxAge, l.localTime, l.compress)
